...
int main(int argc, char **argv) {
    ...
    matrix_local = (double *)malloc(n_local_rows * n_local_cols * sizeof(double));
    temp_matrix = (double *)malloc(n_local_rows * n_local_cols * sizeof(double));
    ...
    MPI_Cart_sub(cart_comm, (int [2]) {0,1}, &row_comm);
    MPI_Cart_sub(cart_comm, (int [2]) {1,0}, &col_comm);
